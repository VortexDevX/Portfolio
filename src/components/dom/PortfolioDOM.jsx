  ...
  <div className="h-screen flex flex-col justify-center max-w-7xl mx-auto px-8 w-full z-10 overflow-hidden py-10">
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-20 w-full items-center">
      <div className="lg:col-span-7 space-y-12">
        <div>
          <h2 className="font-mono text-accent tracking-[0.4em] uppercase mb-6 text-xs border-b border-gray-800 pb-2 inline-block font-bold">
            System Identity
          </h2>
          <p className="font-serif text-2xl md:text-3xl text-gray-300 leading-relaxed text-justify">
            ...
            to deployment. Ready to contribute a meaningful engineering impact
            from day one.
          </p>
        </div>
        <div>
          ...
          <div className="font-mono text-gray-400 font-bold text-[10px] mt-3 uppercase tracking-[0.4em]">
            Expected 2027
          </div>
        </div>
      </div>
      ...
      <div className="lg:col-span-5 bg-[#040812]/95 backdrop-blur-md border border-gray-800 p-8 md:p-10 self-center shadow-2xl">
        <h2 className="font-mono text-accent tracking-[0.4em] uppercase mb-8 text-xs border-b border-gray-800 pb-4 inline-block font-bold">
          Core Competencies
        </h2>
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2 md:gap-3">
        <label className="text-gray-500 font-bold text-[9px] md:text-xs">
          IDENTIFIER_
        </label>
        <input
          type="text"
          name="name"
          required
          className="bg-[#030610] border border-gray-800 focus:border-accent outline-none text-white px-4 md:px-6 py-3 md:py-4 transition-colors cursor-none text-[10px] md:text-xs"
      ...
      <div className="flex flex-col gap-2 md:gap-3">
        ...
        <textarea
          ...
          required
          rows="3"
          className="bg-[#030610] border border-gray-800 focus:border-accent outline-none text-white px-4 md:px-6 py-3 md:py-4 transition-colors resize-none cursor-none text-[10px] md:text-xs"
      ...
      <button
        ...
        className="border border-accent bg-accent/10 hover:bg-accent hover:text-black text-accent px-6 md:px-8 py-3 md:py-5 transition-colors font-bold flex items-center justify-center gap-4 cursor-none group text-[10px] md:text-xs disabled:opacity-40"
      >
...
export default function PortfolioDOM() {
  ...
  return (
    <div
      className={`w-full relative transition-opacity duration-700 ease-in-out ${activeId ? "opacity-0 pointer-events-none" : "opacity-100 pointer-events-auto"}`}
    >
      <HeroSection />
      <AboutSection />
          ...
          <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <div className="flex flex-row md:flex-col gap-3 md:gap-6 font-mono tracking-widest text-gray-400 text-[9px] md:text-xs font-bold uppercase w-full max-w-sm">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group border border-gray-800 hover:border-accent bg-[#040812] hover:bg-accent px-4 md:px-8 py-3 md:py-6 transition-colors hover:text-black flex items-center gap-3 md:gap-6 shadow-2xl cursor-none flex-1 md:flex-none"
              >
                <span className="text-accent group-hover:text-black text-lg md:text-xl leading-none">
                  &gt;
                </span>{" "}
                LINKEDIN
              </a>
